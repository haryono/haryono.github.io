...
<body>
                    ...
                    <li class="pull-right">
                        <ul class="list-inline icon-position">
                            <li>
                                ...
                                <label class="hidden-xs"><a href="mailto:" class="text-white">haryono.yeo@icloud.com</a></label>
                            </li>
                            <li>
    ...
    <div class="copyright">
        <div class="container">
        <p>Copyright &copy; Hyo Admin Template, 2018</p>
        </div>
    </div>
