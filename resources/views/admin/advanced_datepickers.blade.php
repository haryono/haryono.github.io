...
@section('header_styles')
    ...
    <link href="{{ asset('assets/vendors/flatpickrCalendar/css/flatpickr.min.css') }}" rel="stylesheet"
          type="text/css"/>
    <link href="{{ asset('assets/css/pages/adv_date_pickers.css') }}" rel="stylesheet" type="text/css"/> <!--not this-->
                ...
                <div class="panel panel-success">
                    ...
                    <div class="panel-body">
                        <div class="box-body">
                            ...
                            <input class="form-control datepicker1" id="new" type="text" placeholder="Try me..">
                            <!-- phone mask -->
                            <div class="form-group">
                                <label>
                                    MinDate and MaxDate:
...
@section('footer_scripts')
    ...
    <script src="{{ asset('assets/vendors/pickadate/js/picker.js') }}" type="text/javascript"></script> <!--this-->
    <script src="{{ asset('assets/vendors/pickadate/js/picker.date.js') }}" type="text/javascript"></script><!--this-->
    <script src="{{ asset('assets/vendors/pickadate/js/picker.time.js') }}" type="text/javascript"></script>
    <script src="{{ asset('assets/vendors/flatpickrCalendar/js/flatpickr.min.js') }}" type="text/javascript"></script><!--this-->
    <script src="{{ asset('assets/vendors/airDatepicker/js/datepicker.min.js') }}" type="text/javascript"></script>
    <script src="{{ asset('assets/vendors/airDatepicker/js/datepicker.en.js') }}" type="text/javascript"></script>
    <script src="{{ asset('assets/js/pages/custom_datepicker.js') }}" type="text/javascript"></script><!--this-->
