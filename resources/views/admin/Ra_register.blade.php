...
<section class="content-header">
    <!--section starts-->
    <h1>Inventory of Risk Register</h1>
    <ol class="breadcrumb">
        <li>
        ...
        <li class="active">Inventory of Risk Register</li>
    </ol>
</section>
                    ...
                    <div class="panel panel-info table-edit">
                        <div class="panel-heading clearfix">
                            ...
                            <div class="pull-right" >
                                <a href="{{ URL::to('admin/Create_raregister') }}"  class="btn btn-sm btn-default"><span class="glyphicon glyphicon-plus"></span> @lang('button.create')</a>
                            </div>
                        </div>
    ...
    $( document ).ready(function() {
        $(function () {
            ...
            var table = $('#sample_editable_1').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{!! route('admin.ra.datainventory') !!}',
                /*
                ajax: {
