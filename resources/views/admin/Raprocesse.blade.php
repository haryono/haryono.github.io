...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">View RA Processes</li>
    </ol>
</section>
                ...
                <div class="panel panel-info table-edit">
                    <div class="panel-heading clearfix">
                        ...
                        <div class="pull-right" data-toggle="buttons">
                            <a data-href="#create" href="#create" data-toggle="modal" class="btn btn-sm btn-default">@lang('+ Add New RA Process')</a>
                        </div>
                    </div>
    ...
    <div class="modal fade bs-example-modal-sm in" id="create" tabindex="-1" role="dialog" aria-hidden="false">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {{Form::open(array('route' => 'admin.rap.store', 'method' => 'post'))}}
