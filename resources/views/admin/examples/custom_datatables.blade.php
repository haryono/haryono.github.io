                        ...
                        <div class="panel panel-primary filterable">
                            <div class="panel-heading clearfix" >
                                ...
                                <div class="pull-right" data-toggle="buttons">
                                    <label class="btn btn-default tag"  id="pending">
                                        <input type="radio" name="tags" value="button1" id="pending" autocomplete="off" data-value="pending"> halleluyah
                                    </label>
                                    <label class="btn btn-default tag"  id="approved">
                                        <input type="radio" name="tags" value="button2" id="approved" autocomplete="off" data-value="approved"> hi
                                    </label>
                                    <label class="btn btn-default tag"  id="rejected">
                                        <input type="radio" name="tags" value="button3" id="rejected" autocomplete="off" data-value="all"> All
                                    </label>
                                </div>
