...
{{-- Page title --}}
@section('title')
Create New Work Activity Inventory
@parent
@stop
...
<section class="content-header">
    <!--section starts-->
    <h1>Create New Work Activity Inventory</h1>
    <ol class="breadcrumb">
        <li>
        ...
        <li class="active">Create New Work Activity Inventory</li>
    </ol>
</section>
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="livicon" data-name="rocket" data-size="16" data-loop="true" data-c="#fff" data-hc="white"></i> Create New Work Activities from the selected Risk Process
                            </h3>
                        ...
                        <div class="panel-body">
                            <div class="row text-center">
                                <button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModal">
                                    Create Work Activities based on the selected Risk Process
                                </button>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <h4 class="modal-title" id="myModalLabel">Create new Project Work Activities</h4>
                                            </div>
