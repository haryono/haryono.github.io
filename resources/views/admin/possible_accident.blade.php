...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">View Possible Accidents</li>
    </ol>
</section>
    ...
    <div class="modal fade bs-example-modal-sm in" id="create" tabindex="-1" role="dialog" aria-hidden="false">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {{Form::open(array('route' => 'admin.pa.store', 'method' => 'post'))}}
    ...
    $( document ).ready(function() {
        $(function () {
            ...
            function saveRow(table, nRow) {
                ...
                $.ajax({
                    type: "post",
                    url: 'possible_accident/' + row_id + '/update',
                    data: tableData,
            ...
            table.on('click', '.delete', function (e) {
                ...
                if (nEditing !== null && nEditing != nRow) {
                    ...
                    $('#deleteConfirmModal').on('click', '#delete_item', function (e) {
                        $.ajax({
                            type: "get",
                            url: 'possible_accident/' + id + '/delete',
                            success: function (result) {
