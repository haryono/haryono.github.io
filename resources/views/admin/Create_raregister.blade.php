...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Create RA Register</li>
    </ol>
</section>
...
<section class="content">
        <!-- Second Data Table -->
        <form action="{{ route('admin.processreg') }}" method="POST" id="reg_form" enctype="multipart/form-data">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="livicon" data-name="rocket" data-size="16" data-loop="true" data-c="#fff" data-hc="white"></i> Create New RA Register from the selected Risk Process
                            </h3>
                        ...
                        <div class="panel-body">
                            <div class="row text-center">
                                <button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModal">
                                    Create RA Register based on the selected Risk Process
                                </button>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <h4 class="modal-title" id="myModalLabel">Create new RA Register</h4>
                                            </div>
