...
<section class="content-header">
    <!--section starts-->
    <h1>View Additional Risk Control</h1>
    <ol class="breadcrumb">
        <li>
        ...
        <li class="active">View Additional Risk Control</li>
    </ol>
</section>
    ...
    <div class="modal fade bs-example-modal-sm in" id="create" tabindex="-1" role="dialog" aria-hidden="false">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {{Form::open(array('route' => 'admin.arc.store', 'method' => 'post'))}}
    ...
    $( document ).ready(function() {
        $(function () {
            ...
            function saveRow(table, nRow) {
                ...
                $.ajax({
                    type: "post",
                    url: 'Additional_risk_control/' + row_id + '/update',
                    data: tableData,
            ...
            table.on('click', '.delete', function (e) {
                ...
                if (nEditing !== null && nEditing != nRow) {
                    ...
                    $('#deleteConfirmModal').on('click', '#delete_item', function (e) {
                        $.ajax({
                            type: "get",
                            url: 'Additional_risk_control/' + id + '/delete',
                            success: function (result) {
