...
**/
    ...
    var tablesalesperson = $('#tablesalesperson').DataTable({responsive: true,"bPaginate": false,"info":false, "bFilter":false,});
    //row addition code
    $('#addButton').on('click', function (e) {
        e.preventDefault();
        if(counter <= max_fields){
            tablesalesperson.row.add([
            '<input type="text" class="form-control" name="salesperson_name[]" placeholder="e.g. David Coolie" />',
            '<input type="text" class="form-control"  name="service_type[]" placeholder="e.g. tourism" />',
            '<input type="date" class="form-control" name="commence_date[]" placeholder="e.g. 12/12/2016" />',
            '<input type="date" class="form-control" name="expiry_date[]" placeholder="e.g. 24/12/2017" />'
            ]).draw();
            counter++;
        }
    });
    //row deletion code
    $('#tablesalesperson tbody').on('click', 'tr', function () {
        if ($(this).hasClass('danger')) {
            $(this).removeClass('danger');
        } else {
            tablesalesperson.$('tr.danger').removeClass('danger');
            $(this).addClass('danger');
        }
    });
    $('#delButton').click(function () {
        if (!$("#tablesalesperson tr").hasClass('danger')) {
            alert('please select a row first');
            //exit;
        }
        tablesalesperson.row('.danger').remove().draw(false);
        counter--;
    });
...
**/
    // add row, delete row example
    var tableconsultant = $('#tableconsultant').DataTable({responsive: true,"bPaginate": false,"info":false, "bFilter":false,});
    //row addition code
    $('#addButton2').on('click', function (e) {
        e.preventDefault();
        if(counter2 <= max_fields2){
            tableconsultant.row.add([
    ...
    //row deletion code
    $('#tableconsultant tbody').on('click', 'tr', function () {
        if ($(this).hasClass('danger')) {
            $(this).removeClass('danger');
        } else {
            tableconsultant.$('tr.danger').removeClass('danger');
            $(this).addClass('danger');
        }
    });

    $('#delButton2').click(function () {
        if (!$("#tableconsultant tr").hasClass('danger')) {
            alert('please select a row first');
            //exit;
        }
        tableconsultant.row('.danger').remove().draw(false);
        counter2--;
    });
/**
...
**/
    // add row, delete row example
    var tablebizsafe1 = $('#tablebizsafe1').DataTable({responsive: true,"bPaginate": false,"info":false, "bFilter":false,});
    //row addition code
...
**/
    // add row, delete row example
    var tablebizsafe2 = $('#tablebizsafe2').DataTable({responsive: true,"bPaginate": false,"info":false, "bFilter":false,});
    //row addition code
...
**/
    // add row, delete row example
    var tablebizsafe3 = $('#tablebizsafe3').DataTable({responsive: true,"bPaginate": false,"info":false, "bFilter":false,});
    //row addition code
...
**/
    // add row, delete row example
    var tablestd1 = $('#tablestd1').DataTable({responsive: true,"bPaginate": false,"info":false, "bFilter":false,});
    //row addition code
...
**/
    // add row, delete row example
    var tablestd2 = $('#tablestd2').DataTable({responsive: true,"bPaginate": false,"info":false, "bFilter":false,});
    //row addition code
...
**/
    // add row, delete row example
    var tablestd3 = $('#tablestd3').DataTable({responsive: true,"bPaginate": false,"info":false, "bFilter":false,});
    //row addition code
